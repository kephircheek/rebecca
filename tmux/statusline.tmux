...
set -g status-right "#[fg=colour10,bg=colour66,nobold,nounderscore,noitalics]#[fg=colour234,bg=colour66] #(ssh_status) #[fg=colour251,bg=colour66,nobold,nounderscore,noitalics]#[fg=colour234,bg=colour251] %a %d | %b | %R #[fg=colour238,bg=colour251,nobold,nounderscore,noitalics]#[fg=colour252,bg=colour238] #H "
